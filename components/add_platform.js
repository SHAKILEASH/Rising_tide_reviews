...
class addPlatform extends Component {
    constructor(props) {
        ...
        this.name = this.props.route.params.platform.slice(5);
    ...
    render() {
        return (
          <View style={styles.container}>
            <Text style = {{marginLeft:0,backgroundColor:"#d9d9d9",height:"10%",textAlign: 'center',fontWeight: 'bold',width:"100%",fontSize: 18,padding:20}}>ADD Review Platform</Text>  
            <View style = {{alignItems:"center",justifyContent: "center",padding:"10%"}}>
            <Text style = {{fontSize:20,textAlign: 'center',color:"#1792d5",fontWeight: 'bold'}}>{this.name} My Business</Text></View>
            ...
            <TouchableOpacity style={styles.signupBtn} onPress = {() => this.props.navigation.navigate('homePage')} >
                    <Text style={{fontWeight:"bold",color:"white"}}>SET GMB PLATFORM</Text>
                </TouchableOpacity> 
